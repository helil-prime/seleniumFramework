...
//  }
  ...
  public void testTest(String input, String location) {
...
//	  testData[0][1] = "DC";
//	  
//	  testData[1][0] = "Cool Coffee mug";
//	  testData[1][1] = "Chicago";
//	  
//	  testData[2][0] = "Coffee mug";
//	  testData[2][1] = "LA";
//	  
//	  testData[3][0] = "Cool Coffee mug";
//	  testData[3][1] = "Reston";
	  
	  return new String[][] 
		{
		  {"Coffee mug", "DC"},
		  {"cool Coffee mug", "chicago"},
		  {"cute Coffee mug", "LA"},
		  {"ugly Coffee mug", "Reston"}
